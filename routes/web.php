...
Route::namespace('App\Http\Controllers\Front')->group(function() {
    ...
    Route::post('NewAdmin', 'VendorController@AdminRegister'); // the register HTML form submission in vendor login_register.blade.php page
    ...
    Route::get( 'CustomerService', 'CmsController@customerServices');
    Route::get( 'Terms', 'CmsController@TermsCondition');
